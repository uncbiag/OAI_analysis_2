...
def split_tibial_cartilage_surface(mesh, mesh_normals, mesh_centroids):
    ...
    est = KMeans(n_clusters=2, init='random', algorithm="elkan", n_init=1, random_state=5)
...
def cluster_and_segment(mesh_centroids_normalized, face_normal_value, dot_output):
    ...
    est1 = KMeans(n_clusters=2, init='random', algorithm="elkan", n_init=1, random_state=5)
